...
const EXTENSION_POINTS_VERSION = 'MB4.1.0.0';
...
const EXTENSION_POINTS = deepFreeze({
  ...
  PROGRAM_6_HARDENING: {
    ...
    activated: false,
    implemented: false,
    description: 'Future hardening of pipeline integration controls.',
  },
  PROGRAM_7_OPERATOR_ANALYTICS: {
    ...
    activated: false,
    implemented: false,
    description: 'Future operator analytics over pipeline integration.',
  },
