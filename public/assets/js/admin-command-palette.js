...
(function () {
  ...
  const ROUTES = [
    ...
    { label: "Detected Updates", href: "/admin/monitoring#recentUpdates", group: "Go to", keywords: "detections change official" },
    ...
    { label: "Page Generator", href: "/generator", group: "Go to", keywords: "create new job extract convert" },
    ...
    { label: "Automation Activity", href: "/admin/automation-control-center#accAudit", group: "Go to", keywords: "audit automation activity" },
