...
(function () {
  ...
  const ROUTES = [
    ...
    { label: "Open Events", href: "/admin/recruitments#eventTimeline", group: "Quick actions", keywords: "timeline events recruitment" },
    { label: "Search Recruitments", href: "/admin/recruitments", group: "Quick actions", keywords: "find filter search" },
    { label: "Open Source Manager", href: "/admin/monitoring", group: "Quick actions", keywords: "official sources domains crawl manager monitoring" },
    ...
    { label: "Media Library", href: "/admin/media", group: "Go to", keywords: "files pdf upload image media assets" },
    { label: "Upload PDF", href: "/admin/media", group: "Go to", keywords: "files pdf extract upload" },
    { label: "Trash", href: "/trash", group: "Go to", keywords: "deleted restore" },
    { label: "Official Sources", href: "/admin/monitoring", group: "Go to", keywords: "official sources registry monitoring" },
