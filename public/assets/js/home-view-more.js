(function initHomeViewMore(global) {
  "use strict";
  ...
  function buildHomeViewMoreLinkHtml(def, payload, escapeHtml, escapeAttr) {
    ...
    return `<div class="card-view-more"><a href="${escAttr(href)}" class="view-more ${accent}" aria-label="${escAttr(ariaLabel)}"><span class="view-more__text">${esc(label)}</span><span class="view-more__arrow" aria-hidden="true">→</span></a></div>`;
  }
